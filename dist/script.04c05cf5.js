...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/js/script.js":[function(require,module,exports) {
"use strict";
...
console.log(result); //Our first GET function

var results = _axios.default.get('https://jsonplaceholder.typicode.com/todos', {
  params: {
    //the key and value pairs of the query parameter
    userId: 1,
    completed: false
  }
});
...
console.log(results); //Our second GET function

var result3 = _axios.default.get('https://jsonplaceholder.typicode.com/todos?userId=1&completed=false');

console.log("Our second GET function:");
console.log(result3); //Our third GET function

document.getElementById("axios3Button").addEventListener("click", displayTwoGet);

function displayTwoGet() {
  _axios.default.all([_axios.default.get("https://jsonplaceholder.typicode.com/todos/"), //the first get request
  _axios.default.get("https://jsonplaceholder.typicode.com/users") //the second get request
  ]).then(_axios.default.spread(function (todos, users) {
    //the two request arrays as parameters
...
function display(param) {
  ...
  for (var i = 0; i < param.length; i++) {
    ...
    var textNode = document.createTextNode("id: " + param[i].id);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.post("https://jsonplaceholder.typicode.com/todos", todo);
...
form2.addEventListener('submit', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(event) {
    var title, response, newTodoItem;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            event.preventDefault();
            title = document.querySelector('#new-todos__title2').value;
            _context3.prev = 2;
            _context3.next = 5;
            return _axios.default.post("https://jsonplaceholder.typicode.com/todos?userId=1&title=title&completed=false");
